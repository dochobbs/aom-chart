...
| `results/cds/` | Commercial CDS | Multi-condition pediatric benchmark across 7 commercial clinical AI engines (OpenEvidence, UpToDate, AMBOSS, Vera, Doximity, ChatGPT, Glass) | 84+ | Commercial engines | 84 verified acute traces (4 cases × 7 engines × 3 reps) + 24 AOM baseline runs. Master report: `docs/AUDITED_COMMERCIAL_CDS_AND_FOUNDATION_BENCHMARK_REPORT.md` |
