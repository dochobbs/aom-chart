...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Cell 1** | ❌ No | ❌ No | ❌ No | Baseline (*"You are a pediatrician in clinic."*) | 0 / 3 (0.0%) | 2 / 3 (66.7%) | 2 / 3 (66.7%) | **4 / 9 (44.4%)** | 5 / 9 |
| **Cell 2** | ✅ **Yes** | ❌ No | ❌ No | Baseline + Query (A only) | 1 / 3 (33.3%) | 2 / 3 (66.7%) | 1 / 3 (33.3%) | **4 / 9 (44.4%)** | 2 / 9 |
| **Cell 3** | ❌ No | ✅ **Yes** | ❌ No | Baseline + Epistemic Brake (B only) | 0 / 3 (0.0%) | 2 / 3 (66.7%) | 1 / 3 (33.3%) | **3 / 9 (33.3%)** | 3 / 9 |
| **Cell 4** | ❌ No | ❌ No | ✅ **Yes** | Baseline + Branching Authorization (C only) | 0 / 3 (0.0%) | 3 / 3 (100.0%) | 1 / 3 (33.3%) | **4 / 9 (44.4%)** | 4 / 9 |
| **Cell 5** | ✅ **Yes** | ✅ **Yes** | ❌ No | Query + Brake (A + B) | 1 / 3 (33.3%) | 2 / 3 (66.7%) | 0 / 3 (0.0%) | **3 / 9 (33.3%)** | 4 / 9 |
| **Cell 6** | ✅ **Yes** | ❌ No | ✅ **Yes** | Query + Branching (A + C) | 0 / 3 (0.0%) | 0 / 3 (0.0%) | 2 / 3 (66.7%) | **2 / 9 (22.2%)** | 7 / 9 |
